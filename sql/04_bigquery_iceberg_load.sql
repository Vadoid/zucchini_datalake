...
-- date_sk 20250001..20250365) so the common_layer joins resolve.
--
...
INSERT INTO `bigquery_iceberg.web_sales`
  (ws_order_number, ws_item_sk, ws_sold_date_sk, ws_bill_customer_sk,
...
INSERT INTO `bigquery_iceberg.web_returns`
  (wr_order_number, wr_item_sk, wr_returned_date_sk, wr_return_quantity, wr_return_amt)
SELECT
